...
///
        ...
        var clientSecond = dbServiceClient.saveClient(new Client(null, "dbServiceSecond", new Address(null, "OtherStreet"), List.of(new Phone(null, "16-555-22"),
                new Phone(null, "15-666-333"))));
        //System.gc();
